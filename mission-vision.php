<body>
                ...
                <div class="hero-layout">
                    <div class="hero-title sm-pb">
                        <h1 class="text-white mb-0">
                            ...
                            <span class="d-block">
                                <span>Grounded</span>
                                <span class=""><span class="wrap_in"><span class="pulse-animate"><span class="pulse_dot"></span><span class="d-inline-block overflow-hidden"><img src="./images/object-i-img.svg" alt="I-img" class="object_i"></span></span>n</span><span class="pd_italic"><em> Action</em><span class="dot-animated text_green"><span class="pulse-animate"><span class="pulse_dot"></span></span></span>
                            </span>
                        </h1>
    ...
    <section class="vision-wrapper sec-space">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="vision-desc mb-0">“To serve the people with integrity, empathy, and courage, building a Nigeria where dignity is a right, not a privilege. Every initiative, every effort, every word is rooted in the real needs of our communities.”</p>
                </div>
            </div>
        </div>
    </section>
    <section class="vision-wrapper vision-main p-sec-top">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p class="vision-desc v-reveal mb-0">“A nation where security is humane, education is empowering, and the youth lead the way forward. A future built not from the top down, but from the ground up, through collaboration, transparency, and trust.”</p>
                </div>
            </div>
        </div>
    </section>
   ...
   <div class="marquee-led-driven sec-space">
    ...
    <section class="updates-feed work-feed sec-space m-sec-bottom overflow-hidden sm-feeds">
