    ...
    <div class="homepage resourses">
            ...
            <div class="hero-banner">
                <div class="hero-layout">
                    <div class="hero-title">
                        ...
                        <p class="text-white mb-0">Explore curated documents, insights, and tools that bring Oluwadare’s mission to life — from policy papers to community reports.</p>
                    </div>
     ...
     <section class="vision-wrapper purpose sec-space">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h2 class="main-title apc-anim">Oluwadare &<span class="apc-img-animate overflow-hidden position-relative d-inline-block"><span class="apc-imgs"><img src="images/apc-lg.svg" class="ap-01" alt="apc"><img src="images/apc-lg.svg" class="ap-02" alt="apc"></span></span><span class="d-block">A Shared <i class="pd_italic text_green">Vision</i><span class="dot-animated text_green"><span class="pulse-animate"><span class="pulse_dot"></span></span></span></span></span></h2>
                </div>
                <div class="col-md-5">
                    <p class="vision-desc">Oluwadare Owolabi’s political path is grounded in purpose and shaped by collective action. As a proud member of the All Progressives Congress (APC), he stands aligned with a national vision of equity, opportunity, and accountable leadership.</p>
                    <p class="vision-desc">In a rapidly evolving political landscape, staying informed about his initiatives, policies, and public engagements is crucial. It allows citizens, collaborators, and changemakers to align with the momentum of progress, actively participate in democratic discourse, and hold leadership accountable — because real change requires collective awareness and timely action.</p>
                </div>
            </div>
        </div>
    </section>
